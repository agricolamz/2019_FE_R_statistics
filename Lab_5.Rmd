...
.parallax {
    /* The image used */
    background-image: url("5_strings.jpg");
...
#### 3.4 Сравнение
```{r}
c <- c("brown fox", "jumps", "over the lazy dog", "the quick")
a; c
setequal(c, a)
identical(c, a)
```
...
a
is.element("jumps", a)
is.element("the lazy dog", a)
is.element(c("jumps", "the lazy dog"), a)
c("jumps", "the lazy dog") %in% a
```
